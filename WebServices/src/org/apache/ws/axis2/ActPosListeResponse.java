 ...
 */
            ...
            /**
            *  ActPosListeResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ActPosListeResponse
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ActPosListeResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "ActPosListeResponse",
    ...
    public static class Factory{
        ...
        */
        public static ActPosListeResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ActPosListeResponse object =
                new ActPosListeResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ActPosListeResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ActPosListeResponse)org.apache.ws.axis2.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
