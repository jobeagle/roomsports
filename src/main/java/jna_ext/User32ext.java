 ...
 *****************************************************************************
 * User32ext.java: Interface für Zugriff auf user32.dll , die nicht in der 
 * platform.jar enthalten sind.
 *****************************************************************************
 */

public interface User32ext extends StdCallLibrary, WinUser {
 ...
 * the window does not receive input such as mouse clicks and key presses. When input is enabled, 
 * the window receives all input.
 * @param hWnd		A handle to the window to be enabled or disabled. 
 * @param bEnable	Indicates whether to enable or disable the window. If this parameter is TRUE, the window is enabled. 
 ...
 * @param hWnd			A handle to the window to be closed.
 * @param fShutDown		Ignored. Must be FALSE.
 * @param fForce		A TRUE for this parameter will force the destruction of the window if an initial attempt 
 *   fails to gently close the window using WM_CLOSE. With a FALSE for this parameter, only the close with WM_CLOSE is attempted. 
 * @return				If the function succeeds, the return value is nonzero.
 *   If the function fails, the return value is FALSE. To get extended error information, call GetLastError. 
 * 
 */
boolean EndTask(HWND hWnd, boolean fShutDown, boolean fForce);
