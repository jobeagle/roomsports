...
public class JStravaV3 implements JStrava {
    ...
    public List<Stream> findEffortStreams(long activityId, String[] types) {
        ...
        String URL="https://www.strava.com/api/v3/segment_efforts/"+activityId+"/streams/"+builder.toString();
        String result= getResult(URL);
    ...
    public List<Stream> findSegmentStreams(long activityId, String[] types) {
        ...
        String URL="https://www.strava.com/api/v3/segments/"+activityId+"/streams/"+builder.toString();
        String result= getResult(URL);
    ...
    public List<Stream> findSegmentStreams(long activityId, String[] types, String resolution, String series_type) {
        ...
        String URL="https://www.strava.com/api/v3/segments/"+activityId+"/streams/"+builder.toString()+"?resolution="+resolution;
...
//	System.out.println("Debug: result: " + result);
    ...
    private String getResult(String URL, HashMap<String, String> optionalParameters){
        StringBuilder sb= new StringBuilder();
        sb.append(URL);
        try {
	...
	*/
    ...
    private String putResult(String URL, HashMap<String, String> optionalParameters){
        StringBuilder sb= new StringBuilder();
        sb.append(URL);
        try {
