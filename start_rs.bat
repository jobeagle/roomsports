rem start_rs.bat ist Teil der RoomSports-Applikation und freis Software entsprechend GNU GPLv3
rem 
rem Start der RoomSports-Applikation
rem 
...
rem C:\Programme\Java\jre1.8.0_121\bin\java.exe -jar rs.jar -d -g 5
